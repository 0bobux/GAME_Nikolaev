...
for i in range(4): # i - индекс строки
    for j in range(5): # j - индекс столбца
        if board[i][j] != '.':
            ...
            for dx, dy in directions:
                ni = i + dx  # Координаты соседней клетки по строкам.
                nj = j + dy  # Координаты соседней клетки по столбцам.
